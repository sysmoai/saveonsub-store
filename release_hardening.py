...
REPLACEMENTS = {
    ...
    'Shared seats work the same as personal on mobile — the seat type doesn\'t affect functionality.':
        'Mobile availability depends on the provider and exact access method. Shared access can differ from personal access in privacy, continuity, sign-in method and provider-policy risk.',
